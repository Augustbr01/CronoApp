...
- Snap-to-mute abaixo de 1% (RF-04.9) e cancelamento de fade (RF-04.10).
  O limiar era 3: desceu para 1 porque a saída vai a um amplificador, onde 1% e
  2% são volume de sussurro utilizável — ver o comentário em
  [volume.ts](volume.ts).
